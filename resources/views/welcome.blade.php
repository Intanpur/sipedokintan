    ...
    <style>
        ...
        * {
        ...
        body::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at center, rgba(15, 23, 42, 0.3) 0%, rgba(5, 10, 20, 0.7) 100%);
            z-index: 0;
        }
        ...
        .logo-box {
            ...
            padding: 12px;
            border-radius: 24px;
            box-shadow: 0 8px 25px rgba(0, 0, 0, 0.4), 0 0 15px var(--cyan-glow);
        }
        ...
        .btn-login {
            width: 100%;
            padding: 12px;
            background: linear-gradient(135deg, #00f5d4 0%, #00a896 100%);
            color: #002b26;
            border: none;
            border-radius: 12px;
            font-weight: 800;
...
<div class="login-wrapper">
    ...
    <div class="brand-header">
        <div class="logo-box">
            <img src="{{ asset('assets/images/logo-pringsewu.png') }}" class="logo-out" alt="Logo Pringsewu">
        </div>
    </div>
    ...
    <div class="login-card">
        ...
        <div class="text-center">
            <span class="badge-system"><i class="bi bi-shield-check me-1"></i> Diskominfo Pringsewu</span>
            <div class="title">Login SIPEDOK</div>
            <div class="subtitle">Sistem Informasi Pengelolaan Dokumentasi</div>
        </div>
        ...
        <div class="footer-note">
            Belum memiliki akses? <a href="#">Hubungi Administrator</a>
        </div>
